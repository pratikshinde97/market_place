...
class _HomePageState extends State<HomePage> {
              ...
              children: [
                InkWell(
                  child: Center(child: Icon(
                    Icons.add_shopping_cart_outlined, size: 34,
                    color: Colors.white,)),
                  onTap: () {
                    Navigator.push(
                        context,
                ...
                Positioned(
                  ...
                  child: CircleAvatar(
                    ...
                    child: Text('${Provider
                        ...
                        .cartCount}', style: TextStyle(fontSize: 8,
                        color: Colors.white,
  ...
  Future<List<CategoryList>> getCategories(index) async {
    ...
    final res = await http.get(
        "http://192.168.43.23:8081/api/categories/$index/20");
    print("<<<<<<<<<<<<<<<<<<<<<<<<<");
    if (res.statusCode == 200) {
      ...
      usersdata =
          catData.map<CategoryList>((json) => CategoryList.fromJson(json))
              .toList();
      print('$usersdata>>>><<<<<<>>>>><<<<<');
      return usersdata;
    } else {
